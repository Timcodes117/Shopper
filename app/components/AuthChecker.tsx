...
const AuthChecker = () => {
  ...
  return (
    <>
    {
        ...
        :
        <div className="w-[90px] h-[35px] border-[1px] rounded-[100px] cursor-pointer active:opacity-[0.7] border-[orangered] text-[orangered] px-2  flex items-center justify-evenly">
